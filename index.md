...
The validation mode is available only for people in charge of annotators, it can be activated with the ![Alt text](./img/validate.png) mark. Once classes are selected in the taxonomy, they are shown in the workspace:
